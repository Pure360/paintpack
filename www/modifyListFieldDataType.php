<?php
    ...
    $newFieldDataType     = (!empty($_REQUEST["newFieldDataType"])? $_REQUEST["newFieldDataType"]: null);
    $newFieldDataFormat     = (!empty($_REQUEST["newFieldDataFormat"])? $_REQUEST["newFieldDataFormat"]: null);
    $output			= "";
	$listData	= "";
	...
	{		
        ...
        try
        {
            ...
            $listOutput = $paint->modifyListFieldDataType($listId, $oldFieldColNo, $newFieldDataType, $newFieldDataFormat);
...
<body>
    ...
    <div>
        ...
        <br />
        New field Data Type:<input name="newFieldDataType" />
        <br />
        New field Data Format:<input name="newFieldDataFormat" />
        <br />
        <input type="submit" value="Modify list field data type" />
