<?php
	...
	{		
        try
        {
            ...
            $searchResult = $paint->searchLists($listName);
            ...
            $output = "Matching list(s) found (see below)<BR/><BR/>";
...
<body>
    <form action="" method="post">
	    ...
	    <div>
	        ...
	        <br />
			Search lists with a list name parameter (optional)
	        <br />
	        ...
	        <br />
	        Result:<br />
	        <em>(the returned lists will be displayed below)</em><br />
	        <br/>
	        <b>Lists returned:</b>
	        <br/>
	        <br/>
			...
			<br/>
			<br/>
	        <input type="submit" value="Search lists" /></div>
	    </div>
    </form>
</body>
</html>
