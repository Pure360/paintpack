<?php
	...
	{		
        try
        {
            ...
            $searchResult = $paint->searchEmails($messageName);
            ...
            $output = "Matching emails(s) found (see below)<BR/><BR/>";     
...
<body>
    <form action="" method="post">
	    ...
	    <div>
	        ...
	        <br />
			Search emails with a message name parameter (optional)
	        <br />
	        <font color="red"><?php echo $output; ?></font>
			Message (email only) name (optional):<br />
	        <input name="messageName" value="<?php echo $messageName; ?>" size="50"/><br />
	        <br />
	        <br />
	        Result:<br />
	        <em>(the returned emails will be displayed below)</em><br />
	        <br/>
			...
			<br/>
			<br/>
	        <input type="submit" value="Search emails" /></div>
	    </div>
    </form>
</body>
</html>
